...
namespace JN_WEB.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        private readonly ICursosModel _cursosModel;
        private readonly ICarritoModel _carritoModel;

        public HomeController(IUsuariosModel usuariosModel, ICursosModel cursosModel, ICarritoModel carritoModel)
        {
            _usuariosModel = usuariosModel;
            _cursosModel = cursosModel;
        ...
        {
            HttpContext.Session.SetString("NombrePantalla", "Cursos Disponibles");
            var datos = _cursosModel.ConsultarCursos();
